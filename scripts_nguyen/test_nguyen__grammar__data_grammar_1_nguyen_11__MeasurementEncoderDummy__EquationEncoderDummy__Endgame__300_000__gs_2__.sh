#!/bin/bash
#SBATCH --job-name=test_nguyen__grammar__data_grammar_1_nguyen_11__MeasurementEncoderDummy__EquationEncoderDummy__Endgame__300_000__gs_2__ 
#SBATCH -p smp 

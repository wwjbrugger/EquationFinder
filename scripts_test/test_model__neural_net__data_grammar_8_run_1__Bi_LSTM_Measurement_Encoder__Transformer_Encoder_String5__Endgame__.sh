#!/bin/bash
#SBATCH --job-name=test_model__neural_net__data_grammar_8_run_1__Bi_LSTM_Measurement_Encoder__Transformer_Encoder_String5__Endgame__ 
#SBATCH -p smp 
...
--path_to_complete_model saved_models/data_grammar_8/run_1/train_complete_model__neural_net__data_grammar_8_run_1__Bi_LSTM_Measurement_Encoder__Transformer_Encoder_String__Endgame__5__/1/tf_ckpts/ckpt-21 \

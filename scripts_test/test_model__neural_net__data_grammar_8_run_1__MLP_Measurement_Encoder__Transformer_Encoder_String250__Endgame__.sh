#!/bin/bash
#SBATCH --job-name=test_model__neural_net__data_grammar_8_run_1__MLP_Measurement_Encoder__Transformer_Encoder_String250__Endgame__ 
#SBATCH -p smp 
...
--path_to_complete_model saved_models/data_grammar_8/run_1/train_complete_model__neural_net__data_grammar_8_run_1__MLP_Measurement_Encoder__Transformer_Encoder_String__Endgame__250__/1/tf_ckpts/ckpt-21 \
...
--dropout_rate 0.1 \
--class_measurement_encoder MLP_Measurement_Encoder \

...
#SBATCH -J 1000_DatasetTransformer_lin_grammar_1_nguyen_1        # Job name
...
--path_to_complete_model  saved_models/run_1/AlphaZero/DatasetTransformer_lin_1000_81/1/tf_ckpts/ckpt-81 
--experiment_name DatasetTransformer_lin_grammar_1_nguyen_1 

...
class TestEvaluation(unittest.TestCase):
    ...
    def test_multiplication(self):
        ...
        np.testing.assert_almost_equal([5, 10, 15,  20], list(result))

    def test_multiplication_subtree_1(self):
        dict = {'x': [1, 2, 3, 4],
                'y': [5, 10, 15,  20]
                }
        df = pd.DataFrame(dict)
    ...
    def test_multiplication_subtree_5(self):
        dict = {'x': [1, 2, 3, 4],
                'y': [4, 8, 12,  16]
                }
        df = pd.DataFrame(dict)
        ...
        np.testing.assert_almost_equal([4, 8, 12, 16], list(result))

    def test_multiplication_subtree_8(self):
        dict = {'x': [1, 2, 3, 4],
                'y': [5, 10, 15,  20]
                }
        df = pd.DataFrame(dict)
